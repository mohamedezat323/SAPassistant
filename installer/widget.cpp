...
void Widget::on_button1_clicked()
{
    ...
    QString scriptPath = m_settings->value(buttonSettingsKey(0), "").toString();
...
void Widget::on_button2_clicked()
{
    ...
    QString scriptPath = m_settings->value(buttonSettingsKey(1), "").toString();
...
void Widget::on_button3_clicked()
{
    ...
    QString scriptPath = m_settings->value(buttonSettingsKey(2), "").toString();
...
void Widget::on_button4_clicked()
{
    ...
    QString scriptPath = m_settings->value(buttonSettingsKey(3), "").toString();
...
void Widget::on_button5_clicked()
{
    ...
    QString scriptPath = m_settings->value(buttonSettingsKey(4), "").toString();
...
void Widget::on_button6_clicked()
{
    ...
    QString scriptPath = m_settings->value(buttonSettingsKey(5), "").toString();
...
//---------------hotKeys------------------//
    ...
    ui->variantCombo_0->addItems({"/HATEM", "/MOB", "/dryme", "/ME"});

    ui->variantCombo_1->addItems({"/HATEM", "/MOB", "/dryme", "/ME"});

    ui->variantCombo_2->addItems({"/HATEM", "/MOB", "/dryme", "/ME"});

    ui->variantCombo_3->addItems({"/HATEM", "/MOB", "/dryme", "/ME"});

    ui->variantCombo_4->addItems({"/HATEM", "/MOB", "/dryme", "/ME"});

    ui->variantCombo_5->addItems({"/HATEM", "/MOB", "/dryme", "/ME"});
...
// I just cant get out.
// as sad as that sounds this feelings is what shaping me right now, do I like ? no, but I cant really do much about it
